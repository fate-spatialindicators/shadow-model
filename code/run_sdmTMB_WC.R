...
for(spp in 1:length(species)) {
  ...
  for (k in 1:length(performance$knots)) {
    ...
    if(!dir.exists(paste0("C:/Users/cjcco/OneDrive/Desktop/1st Paper/output/WC2/",species[spp]))) dir.create(paste0("C:/Users/cjcco/OneDrive/Desktop/1st Paper/output/WC2/",species[spp]))
    ...
    if(use_cv==TRUE) {
      ...
      saveRDS(density_model, file=paste0("C:/Users/cjcco/OneDrive/Desktop/1st Paper/output/WC2/",species[spp],"/",species[spp],"_",performance$knots[k],"cv_density_depth_varying.rds"))
      ...
      saveRDS(performance, file = paste0("C:/Users/cjcco/OneDrive/Desktop/1st Paper/output/WC2/",species[spp],"_performance_650v2.rds"))
      ...
      saveRDS(density_model, file=paste0("C:/Users/cjcco/OneDrive/Desktop/1st Paper/output/WC/",species[spp],"/",species[spp],"_",performance$knots[k],"_density_depth_varying300knots.rds"))
